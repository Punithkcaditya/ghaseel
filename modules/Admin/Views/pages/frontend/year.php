    ...
    <div class="page-content">
        ...
        <div class="card card-style">
            <div class="content mb-0">
                <h3 style="text-align: center;">Choose Years</h3>
                ...
                <div class="list-group list-custom-small check-visited">
                    <?php   if (!empty($years)) : 
            $i = 1;
            foreach ($years as $main_menus) : ?>
                    <a href="<?php echo site_url("/customerinfo/".$main_menus->id); ?>"  class="year" style="text-align: center;"   data-yearid="<?php echo $main_menus->id ?>" data-yearname="<?php echo $main_menus->year ?>"><span><?= $main_menus->year?></span></a>
                    <?php
        ...
        <div id="menu-success-1" class="menu menu-box-modal maystyle ">
            <a href="#" class="close-menus" onClick="window.location.reload();"><i class="fa fa-window-close"
                    ...
                    <div id="collapse<?= $i ?>" class="collapse" data-bs-parent="#accordion-1">
                        <div class="pt-1 pb-2 ps-3 pe-3">
                            ...
                            <input type="hidden" name="location" id="location" class="form-control" value="<?php echo !empty(
                                            ...
                                            ? $rows
                                            : ""; ?>">
                            <p class="location" data-productid="<?php echo $main_menus->id; ?>"
                                data-productname="<?php echo $rows; ?>"><?= $rows ?></p>
